...
Original file is located at
    https://colab.research.google.com/drive/1zGl1J_or0tS7IlPCiDn_yMbeRMKcxqzU
...
!wget https://github.com/udacity/deep-learning-v2-pytorch/archive/master.zip
...
plt.imsave('test.png', im_convert(target))